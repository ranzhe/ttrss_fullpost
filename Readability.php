...
class Readability
{
	...
	**/
	public $regexps = array(
		...
		'positive' => '/article|body|content|entry|hentry|main|page|attachment|pagination|post|text|blog|story|wpappbox|screenshots|appstore|appdetails|apptitle/i',
	...
	**/
	public function init()
	{
		...
		if (!$articleContent) {
			...
			$articleContent->innerHTML = 'Failed';		
		}
